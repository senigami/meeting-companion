...
| P1 | P6 | Summarize call | The summarizer must return one useful line or nothing. |
...
| P1 | P7 | `GET /api/config` | The UI must be able to disable unavailable OpenAI options. |
...
- **INV-5** - No audio or transcript persistence by default.
