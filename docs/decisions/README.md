...
| [ADR-0003](0003-no-audio-storage-by-default.md) | No audio or transcript persistence by default | Accepted, superseded in part by ADR-0004 |
| [ADR-0004](0004-session-recording-for-tuning.md) | Record transcript and summary text locally, for tuning | Accepted |
| [ADR-0005](0005-viewer-clients.md) | One session broadcasts a content stream to read-only viewer clients | Draft |
