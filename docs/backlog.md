...
| 2. Record the incoming transcription text with timestamps | **Shipped** `f4bfedd` under [ADR-0004](decisions/0004-session-recording-for-tuning.md). The replay source it was really for is [#3](https://github.com/senigami/meeting-companion/issues/3). |
